...
exec "/home/XT/.local/miniconda3-droidsplat/envs/droidsplat/bin/python" run.py \
  ...
  +mapping.resource_admission.fixed_budget=700 \
  +mapping.resource_admission.selection=deterministic_uniform \
  hydra.job.name=003_m01_fixed_budget700_fr1desk_full_eval_r1 \
  hydra.run.dir="/home/XT/gsslam/1_droidsplat/records/003_m01_fixed_budget700_fr1desk_full_eval_r1"
